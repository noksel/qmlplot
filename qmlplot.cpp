...
void CustomPlotItem::initCustomPlot() {
    ...
    connect(m_CustomPlot, &advQCstmPltt::afterReplot, this,
...
void CustomPlotItem::keyPressEvent(QKeyEvent *event)
{
    qDebug() << Q_FUNC_INFO;
    routeKeyEvents(event);
}

void CustomPlotItem::keyReleaseEvent(QKeyEvent *event)
{
    qDebug() << Q_FUNC_INFO;
    routeKeyEvents(event);
}

void CustomPlotItem::enterEvent(QEvent *event)
{
    if (m_CustomPlot) {
        QEvent *newEvent =
...
void CustomPlotItem::routeKeyEvents(QKeyEvent *event)
{
    if (m_CustomPlot) {
        QKeyEvent *newEvent =
            new QKeyEvent(event->type(),event->key(),event->modifiers());
        QCoreApplication::postEvent(m_CustomPlot, newEvent);
    }
